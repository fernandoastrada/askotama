    ...
    <section class="product-single container">
      <div class="row">
        ...
        <div class="col-lg-5" style="padding-right:0px;">
          <div class="d-flex justify-content-between mb-4 pb-md-2" style="font-size:12px;">
            <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
              <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">Home</a>
              <span class="breadcrumb-separator menu-link fw-medium ps-1 pe-1">/</span>
              <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">{{$product->brand->name}}</a>
              <span class="breadcrumb-separator menu-link fw-medium ps-1 pe-1">/</span>
          ...
          <h1 class="product-single__name">{{ strtoupper(str_replace('-', ' ', $product->name)) }}
</h1>
          ...
          <div class="product-single__addtolinks">
            ...
            <!-- <script src="js/details-disclosure.html" defer="defer"></script> -->
             <script type="module" src="https://cdn.jsdelivr.net/npm/@github/details-menu-element@1.0.13/dist/index.js"></script>
