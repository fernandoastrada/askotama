                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      {{$promotion->title}} <br /><strong>{{$promotion->subtitle}}</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">{{$promotion->deskripsi}}</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    {{-- <img loading="lazy" src="assets/images/shop/shop_banner3.jpg" width="630" height="450"
                      ...
                      <img loading="lazy" src="{{ asset('uploads/promotions')}}/{{$promotion->image}}" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
