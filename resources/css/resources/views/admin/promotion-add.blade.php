            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{route('admin.promotion.add')}}">
                        <div class="text-tiny">Promotion</div>
                    </a>
                </li>
                <li>
                    <i class="icon-chevron-right"></i>
                ...
                <li>
                    <div class="text-tiny">New Promotion</div>
                </li>
            </ul>
        </div>
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.promotion.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="name">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="deskripsi" name="deskripsi" tabindex="0" value="{{old('deskripsi')}}" aria-required="true" required="">
                </fieldset>
                <fieldset>
